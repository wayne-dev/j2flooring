...
function property_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Rug builder', 'Post Type General Name', 'sadecweb' ),
		'singular_name'         => _x( 'rug-builder', 'Post Type Singular Name', 'sadecweb' ),
		'menu_name'             => __( 'Rug builder', 'sadecweb' ),
		'name_admin_bar'        => __( 'Rug builder', 'sadecweb' ),
	...
	$args = array(
		'label'                 => __( 'Rug builder', 'sadecweb' ),
		'description'           => __( 'rug builder', 'sadecweb' ),
		'labels'                => $labels,
	...
	register_post_type( 'rug-builder', $args );
